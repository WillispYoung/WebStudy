...
(function(global, factory) {
        ...
        function started(event) {
            ...
            function move(event) {
                ...
                switch (mode) {
                    ...
                    case MODE_DRAG:
                        {
                            if (signX) dx = max$1(W - w0, min$1(E - e0, dx)),
                            w1 = w0 + dx,
                            e1 = e0 + dx;
                            if (signY) dy = max$1(N - n0, min$1(S - s0, dy)),
                            n1 = n0 + dy,
                            s1 = s0 + dy;
                            break;
                        }
                    ...
                    case MODE_CENTER:
                        {
                            if (signX) w1 = max$1(W, min$1(E, w0 - dx * signX)),
                            e1 = max$1(W, min$1(E, e0 + dx * signX));
                            if (signY) n1 = max$1(N, min$1(S, n0 - dy * signY)),
    ...
    function conicConformalRaw(y0, y1) {
        ...
        function project(x, y) {
            if (f > 0) { if (y < -halfPi$2 + epsilon$4) y = -halfPi$2 + epsilon$4; } else { if (y > halfPi$2 - epsilon$4) y = halfPi$2 - epsilon$4; }
    ...
    function link$2(curve) {
        ...
        function link() {
            var buffer, argv = slice$4.call(arguments),
    ...
    function zoom() {
        ...
        zoom.extent = function(_) {
            return arguments.length ? (extent = typeof _ === "function" ? _ : constant$c([
                [+_[0][0], +_[0][1]],
                [+_[1][0], +_[1][1]]
            ]), zoom) : extent;
        };
